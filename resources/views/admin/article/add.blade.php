...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin/index/info')}}">首页</a> &raquo;文章管理
    </div>
    <!--面包屑导航 结束-->
                            ...
                            <script type="text/javascript">
                                ...
                                $(function() {
                                    $('#file_upload').uploadify({
                                        ...
                                        'swf'      : "{{asset('resources/orgjs/uploadify/uploadify.swf')}}",
                                        'uploader' : "{{url('admin/common/uploadimage')}}",
